 ...
 * </p>
 * <ul>
 *   <li>{@link de.tudresden.inf.st.bigraphs.dsl.bDSL.impl.AbstractElementImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.tudresden.inf.st.bigraphs.dsl.bDSL.impl.AbstractElementImpl#getSig <em>Sig</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AbstractElementImpl extends MinimalEObjectImpl.Container implements AbstractElement
{
  ...
  {
    return BDSLPackage.Literals.ABSTRACT_ELEMENT;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BDSLPackage.ABSTRACT_ELEMENT__NAME, oldName, name));
  }
  ...
  public Signature getSig()
  {
    if (sig != null && sig.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, BDSLPackage.ABSTRACT_ELEMENT__SIG, oldSig, sig));
      }
    }
    return sig;
  }
  ...
  public void setSig(Signature newSig)
  {
    ...
    sig = newSig;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BDSLPackage.ABSTRACT_ELEMENT__SIG, oldSig, sig));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BDSLPackage.ABSTRACT_ELEMENT__NAME:
        return getName();
      case BDSLPackage.ABSTRACT_ELEMENT__SIG:
