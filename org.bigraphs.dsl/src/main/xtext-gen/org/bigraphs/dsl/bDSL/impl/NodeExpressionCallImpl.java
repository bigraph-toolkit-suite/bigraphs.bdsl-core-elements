 ...
 * </p>
 * <ul>
 *   <li>{@link org.bigraphs.dsl.bDSL.impl.NodeExpressionCallImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.bigraphs.dsl.bDSL.impl.NodeExpressionCallImpl#getLinks <em>Links</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NodeExpressionCallImpl extends AbstractBigraphDeclarationImpl implements NodeExpressionCall
{
   ...
   * @ordered
   */
  protected EList<NameConstant> links;
   ...
   */
  @Override
  public EList<NameConstant> getLinks()
  {
    if (links == null)
    {
      links = new EObjectContainmentEList<NameConstant>(NameConstant.class, this, BDSLPackage.NODE_EXPRESSION_CALL__LINKS);
    }
    return links;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case BDSLPackage.NODE_EXPRESSION_CALL__LINKS:
        getLinks().clear();
        getLinks().addAll((Collection<? extends NameConstant>)newValue);
        return;
    }
